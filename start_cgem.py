...
FILE_NAME = "/Users/lllowe/SASJ/outputs/GEN_1_1.nc"
##-- END MODIFY ---------------
...
#For A1
setvars['var'] = A1['var']
setvars['name'] = A1['name']
setvars['clim'] = A1['clim']
setvars['cmin'] = A1['cmin']
setvars['cmax'] = A1['cmax']
setvars['cmap'] = A1['cmap']


##---Cut and paste these one at a time------##
#3D plot
setvars['var'] = 'GEN_1_surface'
